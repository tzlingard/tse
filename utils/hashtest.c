...
int main(void) {
  ...
  free(hremove(h1, platecheck, "CS5050", sizeof("CS5O5O")));
  printf("\n\n");
  ...
  printf(
      "Test 7 : Search from table (should print car with 'SUNGOD' plate) \n");
  print_car(hsearch(h1, platecheck, "SUNGOD", sizeof("SUNGOD")));
  printf("\n\n");

  printf(
      "Test 8 : Remove from hash (should remove car with 'CS5050' plate) \n");
  free(hremove(h1, platecheck, "CS5050", sizeof("CS5O5O")));
